...
import { getChatModeDefaultAgentIds } from "./chat-mode-capabilities.js";
...
export const CHAT_MODES: Record<ChatMode, ChatModeDefinition> = {
  conversation: {
    ...
    icon: "💬",
    defaultAgents: getChatModeDefaultAgentIds("conversation"),
  },
  roleplay: {
    id: "roleplay",
    name: "Roleplay",
    ...
    icon: "🎭",
    defaultAgents: getChatModeDefaultAgentIds("roleplay"),
  },
  visual_novel: {
    id: "visual_novel",
    name: "Visual Novel",
    ...
    icon: "🎮",
    defaultAgents: getChatModeDefaultAgentIds("visual_novel"),
  },
  game: {
    id: "game",
    name: "Game",
    ...
    icon: "🎲",
    defaultAgents: getChatModeDefaultAgentIds("game"),
  },
};
